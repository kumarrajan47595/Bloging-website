import { SignupInput } from "@rajankumar/mediun-common";
        ...
        <div className="h-screen flex justify-center flex-col">
            <div className="flex justify-center">
                <div>
                    ...
                    <div className="pt-8">
                        {type === "signup" ? <LabelledInput label="Name" placeholder="Rajan..." onChange={(e) => {
                            setPostInputs({
                                ...postInputs,
                                name: e.target.value
                            })
                        }} /> : null}
                        <LabelledInput label="Username" placeholder="rajan@gmail.com" onChange={(e) => {
                            setPostInputs({
                                ...postInputs,
